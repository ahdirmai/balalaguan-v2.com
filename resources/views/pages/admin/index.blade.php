...
@section('content')
    <section class="container-lg">
        ...
        <section class="row mb-4">
            ...
            <x-dashboard.card-widget card-title="4968" card-subtitle="Stock Ticket"/>
            {{-- Amount of Tickets Sold --}}
            <x-dashboard.card-widget card-title="1230" card-subtitle="Tickets Sold" card-colour="bg-warning"/>
            {{-- Amount of User Register --}}
            <x-dashboard.card-widget card-title="968" card-subtitle="User Register" card-colour="bg-success"/>
            {{-- Amount of Successful Transaction --}}
            <x-dashboard.card-widget card-title="40" card-subtitle="Sold Out Today" card-colour="bg-info"/>
        </section>
