...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::9lgH8GFNimBfrzNq',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::X7XDQCOIPD5UiML3',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::eRoMw7nAD3mpCrXx',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::oq8uabIutNrM6Npv',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::LewJJavobS9PatPD',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::JwdmPzv8bHIcIDoK',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.transactions.indexAll',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.transactions.indexVerified',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/livewire/(?|message/([^/]++)(*:36)|preview\\-file/([^/]++)(*:65))|/password/reset/([^/]++)(*:97)|/user/(?|profile/([^/]++)(?|(*:132)|/edit(*:145)|(*:153))|transaction/(?|detail/([^/]++)(*:192)|([^/]++)/([^/]++)(*:217)|payment/([^/]++)(*:241)))|/admin/(?|categories/([^/]++)(?|(*:283)|/edit(*:296)|(*:304))|p(?|hases/([^/]++)(?|(*:334)|/edit(*:347)|(*:355))|eriods/([^/]++)(?|(*:382)|/edit(*:395)|(*:403)))|t(?|ransactions/(?|reject/([^/]++)(*:447)|([^/]++)(?|(*:466)|/edit(*:479)|(*:487)))|icket/([^/]++)(?|(*:514)|/edit(*:527)|(*:535)))))/?$}sDu',
    ),
    3 => 
    array (
      36 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'user.transaction.create',
          ),
          1 => 
          array (
            0 => 'period_id',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'user.transaction.update',
          ),
          1 => 
          array (
            0 => 'transaction_id',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.transactions.reject',
          ),
          1 => 
          array (
            0 => 'transaction_id',
  ...
  array (
    ...
    return $request->user();
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"00000000000007230000000000000000";}";s:4:"hash";s:44:"jxbS1wh3/uvnRCc/6bgR2bPhy953i/qIZvTCU8T6nvs=";}}',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'generated::eRoMw7nAD3mpCrXx',
      ),
      'fallback' => false,
      'defaults' => 
      array (
...
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"00000000000007250000000000000000";}";s:4:"hash";s:44:"Zk8e05IqTLJOvaohaR9gmnF95eT6Gmk4bDY0HWR6BH8=";}}',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'user/transaction/detail/{transaction_id}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserTransactionController@show',
        'controller' => 'App\\Http\\Controllers\\UserTransactionController@show',
        'as' => 'user.transaction.show',
        'namespace' => NULL,
        'prefix' => '/user',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserTransactionController@store',
        'controller' => 'App\\Http\\Controllers\\UserTransactionController@store',
        'as' => 'user.transaction.store',
        'namespace' => NULL,
        'prefix' => '/user',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'user/transaction/{period_id}/{amount}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserTransactionController@create',
        'controller' => 'App\\Http\\Controllers\\UserTransactionController@create',
        'as' => 'user.transaction.create',
        'namespace' => NULL,
        'prefix' => '/user',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'user/transaction/payment/{transaction_id}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserTransactionController@update',
        'controller' => 'App\\Http\\Controllers\\UserTransactionController@update',
        'as' => 'user.transaction.update',
        'namespace' => NULL,
        'prefix' => '/user',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserTicketController@index',
        'controller' => 'App\\Http\\Controllers\\UserTicketController@index',
        'as' => 'user.ticket.index',
        'namespace' => NULL,
        'prefix' => '/user',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserTransactionController@index',
        'controller' => 'App\\Http\\Controllers\\UserTransactionController@index',
        'as' => 'user.transaction.index',
        'namespace' => NULL,
        'prefix' => '/user',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdminDashboardController@scanner',
        'controller' => 'App\\Http\\Controllers\\AdminDashboardController@scanner',
        'as' => 'admin.scanner',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
    ...
    array (
      ...
      array (
        ...
        'as' => 'admin.phases.index',
        'uses' => 'App\\Http\\Controllers\\PhaseController@index',
        'controller' => 'App\\Http\\Controllers\\PhaseController@index',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'admin.phases.create',
        'uses' => 'App\\Http\\Controllers\\PhaseController@create',
        'controller' => 'App\\Http\\Controllers\\PhaseController@create',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'admin.phases.store',
        'uses' => 'App\\Http\\Controllers\\PhaseController@store',
        'controller' => 'App\\Http\\Controllers\\PhaseController@store',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'admin.phases.show',
        'uses' => 'App\\Http\\Controllers\\PhaseController@show',
        'controller' => 'App\\Http\\Controllers\\PhaseController@show',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'admin.phases.edit',
        'uses' => 'App\\Http\\Controllers\\PhaseController@edit',
        'controller' => 'App\\Http\\Controllers\\PhaseController@edit',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'admin.phases.update',
        'uses' => 'App\\Http\\Controllers\\PhaseController@update',
        'controller' => 'App\\Http\\Controllers\\PhaseController@update',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\PhaseController@destroy',
        'controller' => 'App\\Http\\Controllers\\PhaseController@destroy',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\TransactionController@indexAll',
        'controller' => 'App\\Http\\Controllers\\TransactionController@indexAll',
        'as' => 'admin.transactions.indexAll',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    'admin.transactions.indexVerified' => 
    array (
      'methods' => 
      array (
        0 => 'GET',
      ...
      'uri' => 'admin/transactions/verified',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\TransactionController@indexVerified',
        'controller' => 'App\\Http\\Controllers\\TransactionController@indexVerified',
        'as' => 'admin.transactions.indexVerified',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'admin/transactions/reject/{transaction_id}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\TransactionController@reject',
        'controller' => 'App\\Http\\Controllers\\TransactionController@reject',
        'as' => 'admin.transactions.reject',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
